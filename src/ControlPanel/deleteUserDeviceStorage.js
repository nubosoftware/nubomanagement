...
function get(req, res) {
    ...
    async.series([
        ...
        if (err) {
            ...
            eventLog.logAdminEvent(req.nubodata && req.nubodata.adminLogin, EV_CONST.EV_RESET_USER_STORAGE_DEVICE,
                email, null, `Reset device data for user ${email}, device ${deviceId}`, EV_CONST.WARN);
            res.send({
