...
function get(req, res) {
    ...
    async.series([
        ...
        if (err) {
            ...
            eventLog.logAdminEvent(req.nubodata && req.nubodata.adminLogin, EV_CONST.EV_RESET_USER_STORAGE_GENERAL,
                email, null, `Reset general data for user ${email}`, EV_CONST.WARN);
            res.send({
