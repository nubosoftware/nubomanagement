        ...
        async.waterfall([
            ...
            function(mounts,callback) {
                ...
                var postObj = {
                    ...
                    session: _.pick(session.params, "email", "deviceid","appName","docker_image","audioStreamParams","platid","recording","recording_path","keystoreKey","width","height","nuboGLAddress","useNuboGL"),
